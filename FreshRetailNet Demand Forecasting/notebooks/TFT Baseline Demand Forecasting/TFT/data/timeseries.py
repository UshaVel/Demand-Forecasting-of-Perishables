...
class TimeSeriesDataSet(Dataset):
    ...
    * etc.
    ...
    def _construct_index(self, data: pd.DataFrame, predict_mode: bool) -> pd.DataFrame:
        ...
        df_index_first = g["__time_idx__"].transform(lambda x: x.iloc[0]).to_frame("time_first")
        df_index_last = g["__time_idx__"].transform(lambda x: x.iloc[-1]).to_frame("time_last")
