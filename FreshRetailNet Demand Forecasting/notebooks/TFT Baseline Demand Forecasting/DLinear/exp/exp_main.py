...
TRAIN_DATA_PATH = "/content/drive/MyDrive/Freshnetdata/freshretailnet_train.parquet"
TEST_DATA_PATH = "/content/drive/MyDrive/Freshnetdata/freshretailnet_test.parquet"
...
class Exp_Main(Exp_Basic):
    ...
    def data_organization(self, pred_data_path, target_dates):
        ...
        df_eval = pd.read_parquet(TEST_DATA_PATH)
