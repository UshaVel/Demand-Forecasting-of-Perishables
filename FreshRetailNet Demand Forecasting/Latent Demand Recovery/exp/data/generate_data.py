...
# Local copy of the FreshRetailNet-50K TRAIN split (90 days/series), used for
# latent demand recovery. Update this path if your Drive layout differs.
#  the "test" file (7 days/series, HuggingFace's `eval` split) is NOT
# used here - recovery only ever runs on train (see README for why).
...
def load_train_data() -> pd.DataFrame:
    """Load the FreshRetailNet-50K train split from the local parquet copy."""
